            ...
            <div className="App">
                ...
                <Switch>
                    <Route exact path="/myprofile"
                           render={(props) => (
                                <Profile {...props} user={user} logout={clearUser}/> )} />
                    <Route exact path="/explore"
                           render={(props) => (
                               <Feed {...props} user={user} logout={clearUser} /> )} />
                    <Route exact path="/newPost"
                           render={(props) => (
                               <MakeNewPost {...props} user={user} logout={clearUser} /> )} />
                    <Route exact path="/"
                           render={(props) => (
                               <Login {...props} getUser={getUser} /> )} />
                    <Route exact path="/search"
                           render={(props) => (
                               <RestaurantSearch {...props} getUser={getUser} logout={clearUser} /> )} />
